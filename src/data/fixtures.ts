...
export const DEMO_DATA: AppData = {
  ...
  buckets: [
    ...
    { id: 'groceries', name: 'Groceries', planned: 260, defaultAmount: 260, spent: 84, kind: 'spending' },
    { id: 'bills', name: 'Bills & utilities', planned: 210, defaultAmount: 210, spent: 65, kind: 'spending', dueDay: 3 },
    { id: 'transport', name: 'Getting around', planned: 140, defaultAmount: 140, spent: 38, kind: 'spending' },
    { id: 'fun', name: 'Eating out & fun', planned: 150, defaultAmount: 150, spent: 41, kind: 'spending' },
    { id: 'savings', name: 'Savings', planned: 300, defaultAmount: 300, spent: 300, kind: 'savings' },
    { id: 'other', name: 'Everything else', planned: 130, defaultAmount: 130, spent: 12, kind: 'spending' },
  ],
  bills: SAMPLE_BILLS,
